...
{
    ///
    /// Animator implementation for animating by calling System.Action delegate with normalized time parameter.
    ///
    class ParametrizedActionAnimator : public Animator
    {
    public:
        ...
        /// \param finishCallback The callback called after animation is ended.
        ParametrizedActionAnimator(Action action, FinishCallback finishCallback = [](auto) {});
